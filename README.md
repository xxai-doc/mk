...
Предниот код на веб-локацијата е со отворен код, добредојдовте да помогнете во оптимизирање на преводот

* [Код на предниот дел](https://github.com/xxai-art/web)
